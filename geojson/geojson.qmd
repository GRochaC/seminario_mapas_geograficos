...
O [*geojson.io*](https://geojson.io) é uma ferramenta online open source capaz de abrir arquivos GeoJSON existentes e/ou criar novos arquivos contendo dados geoespaciais, além de fornecer ferramentas de desenho, edição de dados, busca e de exportação.

![](geojson_io.png){fig-align="center"}
